...
mongoose.connect('mongodb://localhost/classzone'); //specify db
...
//list of student
var Students = mongoose.model('Students', studentSchema, 'student');



/* GET home page. */
router.get('/', function(req, res, next) {
  res.render('index', { title: 'ClassZone', author: 'Jimmy' });
});

/* GET students page. */
router.get('/students', function (req, res, next) {
  Students.find().exec(function (err, doc) {
   //err is 1 or 2, doc is a data retrieved from db
